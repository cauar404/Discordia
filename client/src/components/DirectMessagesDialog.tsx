...
export function DirectMessagesDialog() {
  ...
  return <>
    ...
    <DialogTrigger asChild><button data-liquid-dm-trigger className="dm-row w-full"><span className="grid size-7 place-items-center rounded-lg bg-[#cbb38a]/15 text-[#dec99d]"><MessageCircle className="size-4" /></span><span className="truncate">Mensagens diretas</span></button></DialogTrigger>
    <DialogContent data-liquid-surface="direct-messages" className="liquid-dialog border-white/10 bg-[#121722] p-0 text-white sm:max-w-5xl">
      ...
      <div className="grid min-h-[560px] grid-cols-[230px_minmax(0,1fr)]">
        <aside className="liquid-dialog-aside border-r border-white/10 bg-[#171c27] p-3">
