...
export default function Home() {
  ...
  return <main className="app-shell">{call && <ActiveCallBar minimized={callMinimized} microphoneEnabled={callMicrophoneEnabled} participantCount={activeCallParticipants.length || 1} participants={activeCallParticipants} onRestore={() => setCallMinimized(false)} onToggleMicrophone={() => setMicrophoneToggleSignal(signal => signal + 1)} onLeave={() => void closeCall()} />}
