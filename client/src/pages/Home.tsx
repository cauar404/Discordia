...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const refresh = () => { void utils.platform.communities.list.invalidate(); void utils.platform.communities.channels.invalidate(); void utils.platform.communities.members.invalidate(); void utils.platform.messages.list.invalidate(); void utils.social.notifications.list.invalidate(); void utils.social.calls.active.invalidate(); void utils.social.calls.presenceByCommunity.invalidate(); };
  ...
  return <main className={cn("app-shell", call && "call-active")}>
