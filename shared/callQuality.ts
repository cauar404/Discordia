...
export const screenShareProfiles = {
  "540p30": {
    ...
    simulcastLayers: [new VideoPreset(480, 270, 450_000, 30), new VideoPreset(720, 405, 1_000_000, 30), new VideoPreset(960, 540, 1_600_000, 30)] as VideoPreset[],
  },
  "720p30": {
    ...
    simulcastLayers: [new VideoPreset(480, 270, 600_000, 30), new VideoPreset(960, 540, 1_600_000, 30), new VideoPreset(1280, 720, 3_400_000, 30)] as VideoPreset[],
  },
  "1080p30": {
    ...
    simulcastLayers: [new VideoPreset(640, 360, 900_000, 30), new VideoPreset(1280, 720, 3_500_000, 30), new VideoPreset(1920, 1080, 6_500_000, 30)] as VideoPreset[],
  },
  "720p60": {
    label: "720p · 60 fps",
    shortLabel: "720p/60",
    ...
    simulcastLayers: [new VideoPreset(480, 270, 900_000, 30), new VideoPreset(960, 540, 3_200_000, 60), new VideoPreset(1280, 720, 6_000_000, 60)] as VideoPreset[],
  },
  "1080p60": {
    label: "1080p · 60 fps",
    shortLabel: "1080p/60",
    ...
    simulcastLayers: [new VideoPreset(640, 360, 1_000_000, 30), new VideoPreset(1280, 720, 5_500_000, 60), new VideoPreset(1920, 1080, 10_000_000, 60)] as VideoPreset[],
  },
} as const;
